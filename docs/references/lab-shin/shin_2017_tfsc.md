...
local_pdf: none
---
# Shin et al. (2017) — TFSC (5-attribute patent analysis)
...
- TODO_VERIFY exact authors, title, DOI
- Cited in [top-level README](../../../README.md) Use Case 1 row
- Closed access — same handling as [`shin_2015_tfsc`](shin_2015_tfsc.md)
