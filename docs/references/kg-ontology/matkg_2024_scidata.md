...
- Scientific Data is OA (CC BY 4.0) — PDF may be committed:
  `git add -f docs/references/kg-ontology/matkg_2024_scidata.pdf`
- TODO_VERIFY exact title, author list (Venugopal et al.?), DOI, volume/issue
