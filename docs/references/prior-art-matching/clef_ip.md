...
- CLEF-IP papers are OA via CEUR-WS — specific year-papers (2010, 2011, 2013, …) will be added as separate entries when needed
- TODO_VERIFY canonical track-overview citation to put in `references.bib`
- Cited in [top-level README](../../../README.md) Use Case 3 row
